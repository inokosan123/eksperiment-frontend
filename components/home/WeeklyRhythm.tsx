      ...
      {hasAny && (
        <View style={StyleSheet.absoluteFill}>
          <Svg width={11} height={11} viewBox="0 0 24 24">
            <Defs>
              <ClipPath id={clipId}>
                <Rect x="0" y={clipTop} width="24" height="24" />
              </ClipPath>
            </Defs>
        ...
        <View style={s.daysRow}>
          {WEEK_DAYS.map((d, i) => (
            <View key={i} style={s.dayCol}>
              ...
              <FlameMini pct={d.pct} isToday={d.isToday} />
            </View>
          ))}
        </View>
      </TouchableOpacity>
