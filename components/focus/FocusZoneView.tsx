...
const completion = StyleSheet.create({
  ...
  card: { width: '100%', maxWidth: 360, minHeight: 400, borderRadius: 34, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 30, paddingTop: 40, paddingBottom: 30, overflow: 'visible' },
  ...
  copy: { width: '100%', alignItems: 'center', marginTop: 26 },
  eyebrow: { fontFamily: F.sansBold, fontSize: 9.5, lineHeight: 13, letterSpacing: 2, color: '#B89A5A', textTransform: 'uppercase', marginBottom: 9 },
  title: { fontFamily: F.serifSemiBold, fontSize: 36, lineHeight: 41, color: INK, textAlign: 'center', marginBottom: 12 },
  ornamentRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  ...
  body: { fontFamily: F.serif, fontSize: 16.5, lineHeight: 24, color: '#8A8177', textAlign: 'center', paddingHorizontal: 6, marginBottom: 28 },
