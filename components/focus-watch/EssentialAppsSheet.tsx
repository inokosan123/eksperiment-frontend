...
const s = StyleSheet.create({
  ...
  financialRow: { minHeight: 57, flexDirection: 'row', alignItems: 'center', gap: 11, borderTopWidth: 1, borderBottomWidth: 1, borderColor: C.border, paddingHorizontal: 3 },
  plusIcon: { width: 29, height: 29, borderRadius: 10, backgroundColor: C.goldLight, alignItems: 'center', justifyContent: 'center' },
  financialTitle: { fontFamily: F.sansSemiBold, fontSize: 12, color: C.text },
  financialBody: { marginTop: 2, fontFamily: F.sans, fontSize: 9.5, color: C.textSecondary },
  ...
  appName: { flex: 1, fontFamily: F.sansMedium, fontSize: 12.5, color: C.text },
