...
const s = StyleSheet.create({
  ...
  metricLabel: { fontFamily: F.sansBold, fontSize: 8, letterSpacing: 1.2, color: C.textMuted },
  metricValue: { marginTop: 5, fontFamily: F.serifMedium, fontSize: 27, color: C.text },
  metricHint: { marginTop: 2, fontFamily: F.sans, fontSize: 9, color: C.textMuted },
  sectionHeader: { minHeight: 47, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 },
  sectionLabel: { fontFamily: F.sansBold, fontSize: 8, letterSpacing: 1.35, color: C.goldDark },
  sectionTitle: { marginTop: 3, fontFamily: F.serifMedium, fontSize: 20, color: C.text },
  segmentedControl: {
    height: 38,
    flexDirection: 'row',
    borderWidth: 1,
  ...
  segmentText: { fontFamily: F.sansBold, fontSize: 8, letterSpacing: 0.8, color: C.textMuted },
  ...
  selectedDate: { fontFamily: F.serifMedium, fontSize: 16, color: C.text },
  selectedDateMeta: { marginTop: 2, fontFamily: F.sansMedium, fontSize: 8.5, color: C.textMuted },
  dayStrip: { gap: 7, paddingVertical: 12, paddingHorizontal: 2 },
  dayButton: { width: 42, height: 58, borderRadius: 7, borderWidth: 1, borderColor: C.border, backgroundColor: C.surface, alignItems: 'center', justifyContent: 'center' },
  dayButtonSelected: { borderColor: C.goldDark, backgroundColor: C.goldLight },
  dayWeekday: { fontFamily: F.sansBold, fontSize: 7.5, color: C.textMuted },
  dayWeekdaySelected: { color: C.goldDark },
  dayNumber: { marginTop: 3, fontFamily: F.serifMedium, fontSize: 15, color: C.text },
  ...
  planKicker: { fontFamily: F.sansBold, fontSize: 7.5, letterSpacing: 1.15, color: C.textMuted },
  planName: { marginTop: 4, fontFamily: F.serifMedium, fontSize: 18, color: C.text },
  planTarget: { marginTop: 3, fontFamily: F.sansMedium, fontSize: 9, color: C.textSecondary },
  targetTag: { minHeight: 25, maxWidth: 118, flexDirection: 'row', alignItems: 'center', gap: 4, borderRadius: 5, borderWidth: 1, borderColor: C.border, backgroundColor: '#F2EFE8', paddingHorizontal: 8 },
  ...
  targetTagText: { fontFamily: F.sansBold, fontSize: 6.8, letterSpacing: 0.7, color: C.textMuted, textAlign: 'center' },
  targetTagTextKept: { color: '#2F7557' },
  targetTagTextLost: { color: '#A24351' },
  targetTagTextActive: { color: C.goldDark },
  subsectionLabel: { marginTop: 18, marginBottom: 9, fontFamily: F.sansBold, fontSize: 8, letterSpacing: 1.25, color: C.textMuted },
  sessionList: { borderTopWidth: 1, borderBottomWidth: 1, borderColor: C.border },
  separator: { height: 1, backgroundColor: C.border },
  sessionRow: { minHeight: 61, flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, paddingHorizontal: 3 },
  sessionLine: { width: 4, height: 34, borderRadius: 2 },
  sessionName: { fontFamily: F.sansSemiBold, fontSize: 12.5, color: C.text },
  sessionTime: { marginTop: 3, fontFamily: F.sansMedium, fontSize: 8.5, color: C.textMuted, fontVariant: ['tabular-nums'] },
  sessionOutcome: { minHeight: 23, maxWidth: 100, borderRadius: 5, backgroundColor: '#F2EFE8', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 7 },
  sessionOutcomeLost: { backgroundColor: '#F8E7EA' },
  sessionOutcomeText: { fontFamily: F.sansBold, fontSize: 6.8, letterSpacing: 0.65, color: C.textMuted, textAlign: 'center' },
  sessionOutcomeTextLost: { color: '#A24351' },
  consistencyBand: { minHeight: 74, flexDirection: 'row', alignItems: 'center', gap: 12, borderTopWidth: 1, borderBottomWidth: 1, borderColor: C.border, paddingVertical: 13 },
  consistencyIcon: { width: 42, height: 42, borderRadius: 7, backgroundColor: C.goldLight, alignItems: 'center', justifyContent: 'center' },
  consistencyTitle: { fontFamily: F.serifMedium, fontSize: 15, color: C.text },
  consistencyBody: { marginTop: 3, fontFamily: F.sansMedium, fontSize: 9, color: C.textMuted },
});
