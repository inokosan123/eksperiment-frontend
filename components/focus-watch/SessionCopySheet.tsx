...
const s = StyleSheet.create({
  ...
  planRow: { minHeight: 58, flexDirection: 'row', alignItems: 'center', gap: 10 },
  planIcon: { width: 31, height: 31, borderRadius: 10, backgroundColor: C.goldLight, alignItems: 'center', justifyContent: 'center' },
  planName: { fontFamily: F.sansSemiBold, fontSize: 12, color: C.text },
  planMeta: { marginTop: 2, fontFamily: F.sans, fontSize: 8.5, color: C.textMuted },
  sessionsList: { marginLeft: 41, borderLeftWidth: 1, borderLeftColor: '#E5D9BD', paddingLeft: 10, paddingBottom: 8 },
  sessionRow: { minHeight: 50, flexDirection: 'row', alignItems: 'center', gap: 8 },
  sessionRowIncompatible: { opacity: 0.62 },
  sessionNumber: { width: 25, height: 25, borderRadius: 9, backgroundColor: '#F0EFEB', alignItems: 'center', justifyContent: 'center' },
  sessionNumberReady: { backgroundColor: '#E7F2EB' },
  sessionNumberText: { fontFamily: F.sansBold, fontSize: 9, color: C.textSecondary },
  sessionName: { fontFamily: F.sansSemiBold, fontSize: 10.5, color: C.text },
  sessionMeta: { marginTop: 2, fontFamily: F.sans, fontSize: 7.8, color: C.textMuted },
  preview: { marginTop: 12, borderRadius: 16, borderCurve: 'continuous', borderWidth: 1, borderColor: '#CFE4D8', backgroundColor: '#F2F9F5', padding: 12, gap: 9 },
  previewIncompatible: { borderColor: '#E6D4AD', backgroundColor: '#FFF8E8' },
  previewKicker: { fontFamily: F.sansBold, fontSize: 8, letterSpacing: 1.5, color: C.goldDark },
  previewTitle: { fontFamily: F.serifMedium, fontSize: 18, color: C.text },
  previewReason: { fontFamily: F.sansMedium, fontSize: 9, lineHeight: 13, color: '#8D5C1E' },
  ruleSummary: { flexDirection: 'row', flexWrap: 'wrap', gap: 5 },
  ruleChip: { borderRadius: 999, backgroundColor: 'rgba(255,255,255,0.75)', paddingHorizontal: 8, paddingVertical: 5 },
  ruleChipText: { fontFamily: F.sansMedium, fontSize: 8, color: C.textSecondary },
});
