...
const s = StyleSheet.create({
  ...
  boundaryKicker: { fontFamily: F.sansBold, fontSize: 8.5, letterSpacing: 1.6, color: C.textMuted },
  boundaryTitle: { marginTop: 3, fontFamily: F.serifMedium, fontSize: 21, letterSpacing: -0.2, color: C.text },
  boundaryBody: { marginTop: 4, fontFamily: F.serif, fontSize: 13.5, lineHeight: 18.5, color: C.textSecondary },
  ...
  choiceTitle: { fontFamily: F.serifMedium, fontSize: 21, letterSpacing: -0.2, color: C.text },
  choiceBody: { marginTop: 6, fontFamily: F.serif, fontSize: 13.5, lineHeight: 19, color: C.textSecondary },
  grantError: { marginTop: 10, fontFamily: F.sansSemiBold, fontSize: 10.5, lineHeight: 15, color: '#A24351' },
});
