...
const s = StyleSheet.create({
  ...
  thresholdLabel: { textAlign: 'center', fontFamily: F.sansBold, fontSize: 7.5, letterSpacing: 1.2, color: C.textMuted },
  thresholdStepper: { height: 40, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 12, borderCurve: 'continuous', borderWidth: 1, borderColor: C.border, backgroundColor: C.surface, overflow: 'hidden' },
  stepButton: { width: 33, height: 40, alignItems: 'center', justifyContent: 'center' },
  thresholdValue: { fontFamily: F.sansSemiBold, fontSize: 11, fontVariant: ['tabular-nums'] },
  ...
  yearLabel: { fontFamily: F.sansBold, fontSize: 8, letterSpacing: 1.5, color: C.textMuted },
  yearTitle: { marginTop: 2, fontFamily: F.serifMedium, fontSize: 15, color: C.text },
  ...
  legendText: { fontFamily: F.sansMedium, fontSize: 8, color: C.textMuted },
  planningWrap: { gap: 8 },
  planningHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  planningLabel: { fontFamily: F.sansBold, fontSize: 7.5, letterSpacing: 1.3, color: C.textMuted },
  planningValue: { marginTop: 2, fontFamily: F.serifMedium, fontSize: 17, color: C.text },
  railLabels: { height: 14, position: 'relative' },
  railMarkerLabel: { position: 'absolute', transform: [{ translateX: -10 }], fontFamily: F.sansBold, fontSize: 7, letterSpacing: 0.8, color: C.goldDark },
  ...
  railBottomText: { fontFamily: F.sansMedium, fontSize: 7.5, color: C.textMuted },
  warning: { flexDirection: 'row', alignItems: 'flex-start', gap: 7, borderRadius: 12, backgroundColor: '#FFF4DC', paddingHorizontal: 10, paddingVertical: 8 },
  warningStrong: { backgroundColor: '#F9E8EB' },
  warningText: { flex: 1, fontFamily: F.sansMedium, fontSize: 9, lineHeight: 13, color: '#8D5C1E' },
